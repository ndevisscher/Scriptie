...
%\begin{description}
\begin{enumerate}
\item Zijn de methodes gebruikt in \cite{state} toepasbaar op het Nederlandse troonrede corpus?
\item Zijn de resultaten representatief voor de werkelijkheid?
%\end{description}
